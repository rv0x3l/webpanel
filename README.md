...
<img src="docs/img/plugins-mockup.svg" alt="Плагины" width="90%" />

_Плагины: toggle-переключатель отключает плагин, и он пропадает из сайдбара_

<br />

<img src="docs/img/filemanager-mockup.svg" alt="Файловый менеджер" width="90%" />

_Файловый менеджер: дерево слева, редактор справа, синтаксическая подсветка_

<br />

<img src="docs/img/mobile-mockup.svg" alt="Mobile" width="70%" />

_📱 На телефоне работает всё: дашборд адаптивный, в терминале есть экранная клавиатура с `Ctrl/Esc/^O/^X/F-keys`_
...
- [x] 🔔 Telegram алерты
- [x] 🔑 API-токены
- [ ] 📱 Telegram MiniApp (управление панелью прямо из TG)
